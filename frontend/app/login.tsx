...
export default function LoginPage({ navigation }) {
    ...
    const handleEmailChange = (email: string) => {
        ...
        // Check if the entered email matches a saved email
        if (savedCredentials && email.toLowerCase() === savedCredentials.email.toLowerCase()) {
            setPassword(savedCredentials.password);
        } else if (email === '') {
            // Clear password if email is cleared
            setPassword('');
        }
    };
