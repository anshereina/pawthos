...
import { logout as performLogout } from '../utils/auth.utils';
...
function CollapsibleMenu({ open, onClose, setSelectedMenu, navigation, onRequestLogout }: { open: boolean, onClose: () => void, setSelectedMenu: (label: string) => void, navigation: any, onRequestLogout: () => void }) {
...
export default function MainApp({ navigation }: { navigation: any }) {
    ...
    const pageMap: Record<string, any> = {
        ...
        "Appointment Scheduling": <AppointmentSchedulingPage initialAppointmentType={appointmentType} onBack={() => setSelectedMenu('Appointment')} onNavigate={setSelectedMenu} {...navigationData} />, 
        "Pet profile": <PetProfilePage onNavigate={navigateWithData} />,
        "Pain Assessment": <PainAssessmentPage onNavigate={navigateWithData} />, 
        "Register Pet": <RegisterPetPage onNavigate={setSelectedMenu} />, 
        ...
        "Retrieve Dog": <RetrieveDogPage onBack={() => setSelectedMenu('Home')} />,
            ...
            "Integration": <IntegrationPage onSelect={setSelectedMenu} />,
                "CanineIntegration": <CanineIntegrationPage onSelect={setSelectedMenu} />,
    "CanineGuidelineIntegration": <CanineGuidelineIntegrationPage onSelect={setSelectedMenu} />,
    "CanineIntegrationQuestion": <CanineIntegrationQuestionPage onSelect={(label, data) => {
        if (data) {
            setNavigationData(data);
        }
        setSelectedMenu(label);
    ...
    "CanineIntegrationResult": <CanineIntegrationResultPage 
        ...
        onSecondOpinionAppointment={() => setSelectedMenu('SecondOpinionAppointment')}
        selectedAnswers={navigationData.beaap_answers || []}
    />,
    "IntegrationQuestionsDog": <IntegrationQuestionsPage petType="dog" onBack={() => setSelectedMenu('CanineIntegration')} onNext={() => { setSelectedPetType('dog'); setSelectedMenu('IntegrationPicture'); }} />,
