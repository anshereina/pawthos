...
import { createAppointment, AppointmentCreate } from '../../utils/appointments.utils';
...
export default function AppointmentSchedulingPage({ initialAppointmentType, onBack, onNavigate }: { initialAppointmentType?: string, onBack?: () => void, onNavigate?: (page: string) => void }) {
